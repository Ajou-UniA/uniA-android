...
public val UniAIconPack.IcMyPage: ImageVector
    get() {
        if (_icMyPage != null) {
            return _icMyPage!!
        }
        _icMyPage = Builder(name = "IcMyPage", defaultWidth = 24.0.dp, defaultHeight = 23.0.dp,
...
private var _icMyPage: ImageVector? = null
