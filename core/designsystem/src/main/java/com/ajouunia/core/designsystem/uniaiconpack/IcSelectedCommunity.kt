...
public val UniAIconPack.IcSelectedCommunity: ImageVector
    get() {
        if (_icSelectedCommunity != null) {
            return _icSelectedCommunity!!
        }
        _icSelectedCommunity = Builder(name = "IcSelectedCommunity", defaultWidth = 23.0.dp,
...
private var _icSelectedCommunity: ImageVector? = null
