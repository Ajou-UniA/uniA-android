...
@Composable
internal fun GuideTopicMenuDialog(
...
@Composable
private fun GuideTopicMenuItemScreen(
    modifier: Modifier = Modifier,
    isSelected: Boolean,
    title: String,
) = Box(
...
@Composable
private fun GuideTopicMenuDialogPreview() {
...
@Preview(showBackground = true)
@Composable
private fun GuideTopicMenuItemScreenPreview() {
    GuideTopicMenuItemScreen(
        isSelected = true,
